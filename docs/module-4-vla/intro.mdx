...
- [Module 1: ROS 2 Fundamentals](/docs/module-1-ros2-fundamentals) — Actions, services, and message types
- [Module 3: The AI-Robot Brain](/docs/module-3-ai-brain) — Navigation and perception fundamentals
